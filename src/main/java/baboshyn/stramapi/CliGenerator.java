...
public class CliGenerator {
     ...
     */
    protected void assertCliCommandsContainBlocks(List<String> actualCommands, CommandBlock... commandBlocks) {
     ...
     */
    protected static final class CommandBlock {
    ...
    private List<String> joinMainAndSubCommands(List<String> commands) {
